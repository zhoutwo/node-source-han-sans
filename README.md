...
For example, for Simplified Chinese, the font family name becomes "Source Han Sans SC". Refer to [SourceHanSansDesignGuide.pdf](https://github.com/adobe-fonts/source-han-sans/blob/1.002R/SourceHanSansDesignGuide.pdf)
and [SourceHanSansReadMe.pdf](https://github.com/adobe-fonts/source-han-sans/blob/1.002R/SourceHanSansReadMe.pdf) for more information.
